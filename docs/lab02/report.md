...
> Додатковий розділ, який не входить до рекомендованого шаблону
> (розділ 15), але обов'язковий за вимогами розділу 7 методички.
...
добу — та сама помилка, що продемонстрована у Перевірці 2 (розділ
«Ручне тестування числових операцій»). Ризиковий набір даних (−40 °C)
підтвердив коректність формули через відому фізичну точку збігу шкал.чну точку збігу шкал.